...
export const retreatData: RetreatData = {
  overview: {
    ...
    quickReminders: [
      ...
      "Banquet dinner is Day 2 evening — wear your PFP white polo tee",
      "Tea house activity Day 3 morning — casual, comfortable shoes",
  ...
  quickLinks: [
    ...
    { label: "Halal Guide", href: "/halal-guide",  icon: "halal" },
  ],
  ...
  beforeYouGo: [
    ...
    },
    {
      ...
      content: [
        ...
        "Good news if you're on a Singapore (or other foreign) roaming SIM/eSIM: your data usually routes back through your home carrier's network rather than China's domestic gateways, so Google, WhatsApp, Instagram, and Facebook typically work without a VPN — this is why roaming often 'just works' where a local SIM wouldn't.",
        "The catch: this bypass only applies to roaming mobile data. The moment you connect to hotel WiFi, café WiFi, or any local Chinese network, China's firewall applies again and blocked apps stop working. If you'll be using local WiFi at all, set up a VPN before you arrive as backup — most VPN apps cannot be downloaded or activated once you're already in China.",
      ],
    },
    {
      title: "Maps in China — Google Maps will not work",
      content: [
        "Google Maps does not load over local Chinese networks (hotel/café WiFi or a local SIM) — it's blocked along with the rest of Google's services. If you're on foreign roaming data it may still work, but Amap is far more accurate for China regardless. Links in this guide marked 'Open in Amap' are the ones that will reliably work on the ground.",
        "Download Amap (高德地图) before you fly and consider downloading its offline map pack for Shenzhen — handy if you have patchy signal.",
        "Install the Amap app before you arrive if possible — opening Amap links in a mobile browser without the app installed can prompt a login/QR-scan wall. With the app installed, links open straight into it.",
        "Amap's results are mostly in Chinese. After installing, switch the app's language to English in Settings, and use the Chinese address/keywords already provided in this guide for the most accurate results — many spellings don't translate cleanly.",
      ],
    },
    {
      ...
      content: [
        ...
        "Amap (高德地图) — China's most reliable map and navigation app. Google Maps does not work over local Chinese networks — use Amap instead, and download the offline Shenzhen map pack before you fly. See 'Maps in China' below for setup tips.",
    ...
    },
    {
      title: "What to pack",
      content: [
        "PFP white polo tee — required for the Banquet Dinner on Day 2 evening.",
    ...
    },
    {
      ...
      content: [
        ...
        "Day 2 (Banquet Dinner): PFP white polo tee.",
        "Day 3 (Tea House Activity): casual — anything comfy, comfortable shoes.",
  ...
  hotel: {
    ...
    amapUrl: "https://uri.amap.com/search?keyword=深圳希尔顿福田&city=深圳&callnative=0",
    ...
    image: "/images/hotel/exterior.avif",
  },
    ...
    },
    {
      ...
      events: [
        ...
        },
        {
          ...
          dressCode: "Casual — anything comfy",
          tag: "highlight",
        },
        {
          time: "1:00pm onward",
    ...
    malls: [
      {
        ...
        distance: "~12–15 min walk, or 1 stop via Shopping Park metro",
      ...
      },
      {
        ...
        distance: "~15–20 min walk, or short Didi ride",
        amapUrl: "https://uri.amap.com/search?keyword=万象城福田&city=深圳&callnative=0",
        fallbackUrl: "https://maps.google.com/?q=Futian+MixC+Shenzhen",
      },
      {
        name: "One Avenue (卓悦中心)",
        nameZh: "卓悦中心",
        description: "Stylish open-air mall in the Futian CBD with a strong dining and lifestyle brand mix — also one of the spots where Shenzhen's CBD skyline light show is viewed from. Fun fact: 卓悦 (Zhuóyuè) sounds just like PFP's Chinese name, 卓越 (Zhuóyuè)!",
        distance: "~10–20 min walk, or short Didi ride",
        amapUrl: "https://uri.amap.com/search?keyword=卓悦中心&city=深圳&callnative=0",
        note: "Heads up: Shenzhen's Futian CBD light show (visible from One Avenue) is paused for maintenance and upgrades from 30 April to 1 October 2026 — it won't be running during the retreat. It's set to relaunch around National Day (1 October 2026).",
      },
    ],
    food: [
      {
        ...
        distance: "3/F COCO Park (~12–15 min walk)",
        amapUrl: "https://uri.amap.com/search?keyword=金悦轩+购物公园&city=深圳&callnative=0",
      ...
      },
      {
        ...
        distance: "Xinghe COCO Park (~12–15 min walk)",
        amapUrl: "https://uri.amap.com/search?keyword=谭鸭血+星河COCO&city=深圳&callnative=0",
      ...
      },
      {
        ...
        distance: "COCO Park (~12–15 min walk)",
        amapUrl: "https://uri.amap.com/search?keyword=阿元来+购物公园&city=深圳&callnative=0",
      },
      {
        ...
        distance: "3/F COCO Park (~12–15 min walk)",
        amapUrl: "https://uri.amap.com/search?keyword=MULINO+ALIMENTARI+购物公园&city=深圳&callnative=0",
      },
    ],
    cafes: [
      {
        ...
        distance: "COCO Park (~12–15 min walk)",
        amapUrl: "https://uri.amap.com/search?keyword=Arabica咖啡+购物公园&city=深圳&callnative=0",
      ...
      },
      {
        ...
        distance: "~12–15 min walk (COCO Park area)",
        amapUrl: "https://uri.amap.com/search?keyword=喜茶+购物公园&city=深圳&callnative=0",
      },
      {
        name: "Manner Coffee",
        ...
        distance: "~12–15 min walk (COCO Park area)",
        amapUrl: "https://uri.amap.com/search?keyword=Manner+Coffee+福田&city=深圳&callnative=0",
      },
    ],
    nightlife: [
      {
        ...
        distance: "~12–15 min walk (COCO Park area)",
        amapUrl: "https://uri.amap.com/search?keyword=购物公园酒吧街&city=深圳&callnative=0",
      ...
      },
      {
        ...
        distance: "~12–15 min walk (COCO Park area)",
        amapUrl: "https://uri.amap.com/search?keyword=McCawley酒吧+购物公园&city=深圳&callnative=0",
      },
      {
        name: "Glass Hammer",
        description: "Craft beer bar near Shopping Park with a solid selection of local and imported brews — low-key and relaxed.",
        distance: "~12–15 min walk (COCO Park area)",
        amapUrl: "https://uri.amap.com/search?keyword=Glass+Hammer+福田&city=深圳&callnative=0",
      },
    ],
    spas: [
      {
        name: "Tangquan Life TENZ Spa",
        description: "Large 24-hour wellness and spa complex in Futian — massage services, sauna, steam rooms, and relaxation lounges.",
        distance: "~10–15 min by Didi",
        amapUrl: "https://uri.amap.com/search?keyword=汤泉life+TENZ+SPA&city=深圳&callnative=0",
      },
      {
        name: "Aimu Spring Spa (艾沐春天)",
        nameZh: "艾沐春天",
        description: "Ultra-luxury 24-hour spa in Futian with oversized massage beds, hot tubs, free-flow fruit, and an in-house restaurant — popular with overnight stays.",
        distance: "~10 min by Didi (Jinzhonghuan International Business Building, Futian)",
        amapUrl: "https://uri.amap.com/search?keyword=艾沐春天&city=深圳&callnative=0",
      },
    ],
    essentials: [
      {
        name: "FamilyMart / 7-Eleven",
        description: "Convenience stores are everywhere in the Futian CBD — look for one within a couple of blocks of the hotel for snacks, drinks, umbrellas, and travel essentials. More are clustered around COCO Park.",
        distance: "~2–5 min walk to the nearest one",
      },
      {
        name: "Watsons (屈臣氏)",
        description: "Pharmacy and personal care chain — stock up on sunscreen, over-the-counter medication, or toiletries.",
        distance: "COCO Park (~12–15 min walk)",
        amapUrl: "https://uri.amap.com/search?keyword=屈臣氏+购物公园&city=深圳&callnative=0",
      },
      {
    ...
    sightseeing: [
      {
        ...
        distance: "~15–20 min by Didi (Didi recommended over walking, especially in summer heat)",
        amapUrl: "https://uri.amap.com/search?keyword=莲花山公园&city=深圳&callnative=0",
      ...
      },
      {
        ...
        distance: "~10–15 min by Didi, or ~20 min walk",
      ...
      },
      {
        ...
        distance: "~2.2 km south of the CBD (~10–15 min by Didi)",
        amapUrl: "https://uri.amap.com/search?keyword=福田红树林&city=深圳&callnative=0",
        fallbackUrl: "https://maps.google.com/?q=Futian+Mangrove+Nature+Reserve+Shenzhen",
      },
      {
        name: "Nantou Ancient City (南头古城)",
        nameZh: "南头古城",
        description: "A 1,700-year-old walled town, restored into a buzzy mix of historic gates, temples, trendy restaurants, and boutiques — Shenzhen's most accessible 古镇 (ancient town). Open 24 hours; shops generally 11am–9pm.",
        distance: "~15–20 min by Didi (or Metro Line 12 to Nantou Ancient City station)",
        amapUrl: "https://uri.amap.com/search?keyword=南头古城&city=深圳&callnative=0",
      },
      {
        name: "Dapeng Fortress (大鹏所城)",
        nameZh: "大鹏所城",
        description: "A Ming-dynasty walled coastal fortress town turned artsy enclave of cafés and boutiques — Shenzhen's most historic 古镇, but a proper day trip rather than a quick visit.",
        distance: "~2–2.5 hours each way — only for those with a full free day",
        amapUrl: "https://uri.amap.com/search?keyword=大鹏所城&city=深圳&callnative=0",
      },
    ],
  },
  ...
  appsToDownload: {
    mustHave: [
      ...
      },
      {
        ...
        whyNeeded: "Google Maps doesn't work over local Chinese networks. Amap has English interface support, accurate real-time transit info for Shenzhen's metro, and walking/driving directions. Download offline Shenzhen maps for use without mobile data. Note: on Android, install \"AMap Global\" — some features may ask for a Chinese phone number, but core search and navigation work fine without one.",
        badge: "Essential",
    ...
    niceToHave: [
      ...
      },
      {
        ...
        whyNeeded: "Good for ordering food delivery to the hotel room or browsing nearby restaurants with photos and prices. The standalone app requires a Chinese phone number to sign up — but you can skip the download and use Meituan directly as a WeChat Mini Program instead: open WeChat, tap the search bar, type \"美团\", and tap the Mini Program that appears.",
        badge: "Good to have",
      },
      {
        name: "Apollo Go",
