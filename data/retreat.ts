  ...
  beforeYouGo: [
    ...
    },
    {
      ...
      content: [
        ...
        "Important: Google (including Google Maps), WhatsApp, Instagram, and Facebook are blocked in mainland China. Set up a VPN before you arrive if you need access — most VPN apps cannot be downloaded or activated once you are already in China.",
      ],
    },
    {
      title: "Maps in China — Google Maps will not work",
      content: [
        "Google Maps does not load in mainland China — it's blocked along with the rest of Google's services. Links in this guide marked 'Open in Amap' are the ones that will actually work on the ground.",
        ...
        "Some VPNs can unblock Google Maps, but it's slower and less accurate for China than Amap. Amap is the more reliable option for navigation while you're here.",
      ],
    },
    {
      ...
      content: [
        ...
        "Amap (高德地图) — China's most reliable map and navigation app, with English interface support. Google Maps does not work in China — use Amap instead, and download the offline Shenzhen map pack before you fly.",
